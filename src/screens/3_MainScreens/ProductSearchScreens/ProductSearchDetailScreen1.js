...
export default function ProductSearchDetailScreen1(route) {
  ...
  async function post_user_wishlist(item) {
    try {
      ...
      const response = await axios.post(
        `https://${Config.BASE_URL}/dev/post_user_wishlist`,
        {
          productId: item.id,
        },
        {
  ...
  async function post_product_info(item) {
    try {
      ...
      const response = await axios.post(
        `https://${Config.BASE_URL}/dev/post_product_info`,
        {
          productId: item.id,
        },
        {
  ...
  async function put_product_viewIncrease(item) {
    try {
      ...
      const response = await axios.put(
        `https://${Config.BASE_URL}/dev/put_product_viewIncrease`,
        {
          productId: item.id,
        },
        {
  ...
  async function delete_user_wishlist(item) {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://${Config.BASE_URL}/dev/delete_user_wishlist`,
        {
          productId: item.id,
        },
        {
